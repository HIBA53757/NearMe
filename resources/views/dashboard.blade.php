            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6 border-b border-[#561c24]/10 pb-8">
                ...
                <div class="relative group">
                    <div class="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                        <svg class="w-4 h-4 text-[#c7b7a3]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                    </div>
                    <input type="text" placeholder="Search stories..." class="w-full md:w-96 pl-12 pr-6 py-4 border-none bg-white rounded-full shadow-sm focus:ring-2 focus:ring-[#6d2932] text-[#561c24] placeholder-[#c7b7a3] transition-all">
                </div>
            </div>
